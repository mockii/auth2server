package com.mockii.authserver.oauth;

import com.mockii.authserver.config.AppConfig;
...
public class AuthServerOAuth2Config extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
        TokenStore tokenStore = new JdbcTokenStore(authDataSource);
        endpoints
                .authenticationManager(authenticationManager)
                .tokenStore(tokenStore)
                .userDetailsService(userDetailsService); // Persist the tokens in the database
